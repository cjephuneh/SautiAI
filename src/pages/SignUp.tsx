...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center px-6 py-12">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_80%,rgba(147,51,234,0.1),transparent_70%)] pointer-events-none" />
          ...
          <CardHeader className="text-center space-y-4">
            ...
            <div>
              ...
              <CardDescription className="text-gray-600 mt-2">
                Sign up for your SautiAI account to get started
              </CardDescription>
            </div>
          </CardHeader>

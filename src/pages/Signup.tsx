...
import { Mail, Lock, Eye, EyeOff, User, Phone, Sparkles, Shield, Zap, CheckCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Join Sautiai and start managing your debt collection</p>
        </div>
        ...
        <div className="mt-8 grid grid-cols-1 gap-4">
          ...
          <div className="flex items-center gap-3 p-4 bg-white/50 rounded-lg">
            ...
            <span className="text-sm text-gray-700">AI-Powered Collection</span>
          </div>
        </div>
      </div>
    </div>
